...
type GreetServiceClient interface {
	...
	GreetEveryOnce(ctx context.Context, opts ...grpc.CallOption) (GreetService_GreetEveryOnceClient, error)
...
func (c *greetServiceClient) GreetEveryOnce(ctx context.Context, opts ...grpc.CallOption) (GreetService_GreetEveryOnceClient, error) {
	stream, err := c.cc.NewStream(ctx, &GreetService_ServiceDesc.Streams[2], "/greet.GreetService/GreetEveryOnce", opts...)
	if err != nil {
		return nil, err
	}
	x := &greetServiceGreetEveryOnceClient{stream}
	return x, nil
}

type GreetService_GreetEveryOnceClient interface {
	Send(*GreetRequest) error
	Recv() (*GreetResponse, error)
	grpc.ClientStream
}

type greetServiceGreetEveryOnceClient struct {
	grpc.ClientStream
}

func (x *greetServiceGreetEveryOnceClient) Send(m *GreetRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *greetServiceGreetEveryOnceClient) Recv() (*GreetResponse, error) {
	m := new(GreetResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type GreetServiceServer interface {
	...
	GreetEveryOnce(GreetService_GreetEveryOnceServer) error
...
func (UnimplementedGreetServiceServer) GreetEveryOnce(GreetService_GreetEveryOnceServer) error {
	return status.Errorf(codes.Unimplemented, "method GreetEveryOnce not implemented")
}
...
func _GreetService_GreetEveryOnce_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(GreetServiceServer).GreetEveryOnce(&greetServiceGreetEveryOnceServer{stream})
}

type GreetService_GreetEveryOnceServer interface {
	Send(*GreetResponse) error
	Recv() (*GreetRequest, error)
	grpc.ServerStream
}

type greetServiceGreetEveryOnceServer struct {
	grpc.ServerStream
}

func (x *greetServiceGreetEveryOnceServer) Send(m *GreetResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *greetServiceGreetEveryOnceServer) Recv() (*GreetRequest, error) {
	m := new(GreetRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
var GreetService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "GreetEveryOnce",
			Handler:       _GreetService_GreetEveryOnce_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
